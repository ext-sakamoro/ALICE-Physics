...
- **B Iteration 5+ (revised strategy)** — P4 以降の category audit:
  ...
  - **Iter 4b (optional)**: CFD cross-module helpers pub(crate) 化 (design 判断が必要な `MacGrid`/`Grid3d`/`project_pressure`/`g2p_velocity`/`sample_*` 等)
